...
{ 
  ...
  {    
    ...
    $context = stream_context_create(array('http' => array_merge(
      $this->options, 
      array('method' => $method), 
      array('content' => http_build_query($parameters)),
  ...
  function handleRuntimeError($errno, $errstr, $errfile = null, $errline = null, $errcontext = array() )
  {
    ...
    if ($error_types === null)
    {
      ...
      // Forward compatibility with PHP5.3
      if (defined("E_DEPRECATED"))
      {
        $error_types[E_DEPRECATED] = "Deprecated";
        $error_types[E_RECOVERABLE_ERROR] = "Error";
      }
      // Forward compatibility with PHP5.2
