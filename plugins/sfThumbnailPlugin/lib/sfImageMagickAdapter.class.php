...
class sfImageMagickAdapter
{
  ...
  public function save($thumbnail, $thumbDest, $targetMime = null)
  {
    ...
    $cmd = $this->magickCommands['convert'].' '.escapeshellarg($this->image).' '.$command.' '.$extract.' '.escapeshellarg($output);
