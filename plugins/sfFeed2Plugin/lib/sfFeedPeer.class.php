...
class sfFeedPeer
{
  ...
  public static function convertObjectsToItems($objects, $options = array())
  {
    ...
    foreach($objects as $object)
    {
      ...
      $details = array('title', 'description', 'content', 'authorEmail', 'authorName', 'authorLink', 'pubdate', 'comments', 'uniqueId', 'enclosure', 'categories', 'license');
  ...
  private static function getItemFeedLicense($item)
  {
    foreach(array('getFeedLicense', 'getLicense') as $methodName)
    {
      if (method_exists($item, $methodName))
      {
        return $item->$methodName();
