...
class sfFeedItem
{
  ...
  public function initialize($item_array)
  {
    ...
    $this->setLicense(isset($item_array['license']) ? $item_array['license'] : '');
  ...
  {
    if ($license && !($license instanceof sfFeedLicense))
    {
      // FIXME: This shouldn't cause an exception, lets just bail out gracefully
      return $this;

      // the object is of the wrong class
      $error = 'Parameter of setLicense() is not of class sfFeedLicense';
