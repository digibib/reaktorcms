...
// +----------------------------------------------------------------------+
//
// $Id: module.audio-video.quicktime.php,v 1.4 2006/06/13 08:44:50 ah Exp $
        ...
        switch ($atom_name) {
            ...
            case 'stts': // Sample Table Time-to-Sample atom
                ...
                for ($i = 0; $i < $atom_structure['number_entries']; $i++) {
                    ...
                    if (!empty($info_quicktime['time_scale']) && (@$atoms_tructure['time_to_sample_table'][$i]['sample_duration'] > 0)) {                        
            ...
            case 'mvhd': // MoVie HeaDer atom
                ...
                $atom_structure['creation_time_unix']        = (int)($atom_structure['creation_time'] - 2082844800); // DateMac2Unix()
                $atom_structure['modify_time_unix']          = (int)($atom_structure['modify_time']   - 2082844800); // DateMac2Unix()
                $info_quicktime['time_scale']    = $atom_structure['time_scale'];
