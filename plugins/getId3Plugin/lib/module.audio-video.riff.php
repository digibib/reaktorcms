...
// +----------------------------------------------------------------------+
//
// $Id: module.audio-video.riff.php,v 1.5 2006/06/24 22:58:30 ah Exp $
                ...
                default:
                    ...
                    switch ($chunk_name) {
                        case 'data':
                            ...
                            if ((strlen($riff_data_chunk_contents_test) > 0) && (substr($riff_data_chunk_contents_test, 0, 2) == "\x0B\x77")) {
