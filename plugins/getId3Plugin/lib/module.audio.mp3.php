...
// +----------------------------------------------------------------------+
//
// $Id: module.audio.mp3.php,v 1.5 2006/06/24 22:58:30 ah Exp $
...
class getid3_mp3 extends getid3_handler
{
    ...
    public function getOnlyMPEGaudioInfo($fd, &$info, $avdata_offset, $bit_rate_histogram=false) {
        ...
        while (true) {
            ...
            if (($synch_seek_offset > $header_len) && (($avdata_offset + $synch_seek_offset)  < $info['avdataend']) && !feof($fd)) {
                ...
                } elseif ($header .= fread($fd, getid3::FREAD_BUFFER_SIZE)) {
