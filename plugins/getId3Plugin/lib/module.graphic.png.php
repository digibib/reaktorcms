...
// +----------------------------------------------------------------------+
//
// $Id: module.graphic.png.php,v 1.2 2004/11/01 03:11:16 ah Exp $
        ...
        while (((ftell($getid3->fp) - (strlen($png_filedata) - $offset)) < $getid3->info['filesize'])) {
            ...
            switch ($chunk['type_text']) {
                ...
                case 'IHDR': // Image Header
                    ...
                    $info_png_chunk_type_text['width']  = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'],  0, 4));
                    $info_png_chunk_type_text['height'] = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'],  4, 4));
                    
                    getid3_lib::ReadSequence('BigEndian2Int', $info_png_chunk_type_text['raw'], $info_png_chunk_type_text['header']['data'], 8, 
                        array (
                            'bit_depth'          => 1,
                            'color_type'         => 1,
                ...
                case 'PLTE': // Palette
                    ...
                    $palette_offset = 0;
                    for ($i = 0; $i <= 255; $i++) {
                        $red   = @getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']{$palette_offset++});
                        $green = @getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']{$palette_offset++});
                        $blue  = @getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']{$palette_offset++});
                ...
                case 'tRNS': // Transparency
                    ...
                    switch ($info_png['IHDR']['raw']['color_type']) {
                        case 0:
                            $info_png_chunk_type_text['transparent_color_gray']  = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 0, 2));
                            break;

                        case 2:
                            $info_png_chunk_type_text['transparent_color_red']   = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 0, 2));
                            $info_png_chunk_type_text['transparent_color_green'] = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 2, 2));
                            $info_png_chunk_type_text['transparent_color_blue']  = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 4, 2));
                            break;

                        case 3:
                            for ($i = 0; $i < strlen($info_png_chunk_type_text['header']['data']); $i++) {
                                $info_png_chunk_type_text['palette_opacity'][$i] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][$i]);
                            }
                            break;
                ...
                case 'gAMA': // Image Gamma
                    $info_png_chunk_type_text['header'] = $chunk;
                    $info_png_chunk_type_text['gamma']  = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']) / 100000;
                    break;


                case 'cHRM': // Primary Chromaticities
                    $info_png_chunk_type_text['header']  = $chunk;
                    $info_png_chunk_type_text['white_x'] = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'],  0, 4)) / 100000;
                    $info_png_chunk_type_text['white_y'] = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'],  4, 4)) / 100000;
                    $info_png_chunk_type_text['red_y']   = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'],  8, 4)) / 100000;
                    $info_png_chunk_type_text['red_y']   = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 12, 4)) / 100000;
                    $info_png_chunk_type_text['green_y'] = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 16, 4)) / 100000;
                    $info_png_chunk_type_text['green_y'] = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 20, 4)) / 100000;
                    $info_png_chunk_type_text['blue_y']  = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 24, 4)) / 100000;
                    $info_png_chunk_type_text['blue_y']  = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 28, 4)) / 100000;
                    break;


                case 'sRGB': // Standard RGB Color Space
                    $info_png_chunk_type_text['header']                 = $chunk;
                    $info_png_chunk_type_text['reindering_intent']      = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']);
                ...
                case 'iCCP': // Embedded ICC Profile
                    $info_png_chunk_type_text['header']                  = $chunk;
                    list($profilename, $compressiondata)                 = explode("\x00", $info_png_chunk_type_text['header']['data'], 2);
                ...
                case 'tEXt': // Textual Data
                    $info_png_chunk_type_text['header']  = $chunk;
                    list($keyword, $text)                                = explode("\x00", $info_png_chunk_type_text['header']['data'], 2);
                ...
                case 'zTXt': // Compressed Textual Data
                    $info_png_chunk_type_text['header']                  = $chunk;
                    list($keyword, $otherdata)                           = explode("\x00", $info_png_chunk_type_text['header']['data'], 2);
                    $info_png_chunk_type_text['keyword']                 = $keyword;
                ...
                case 'bKGD': // Background Color
                    ...
                    switch ($info_png['IHDR']['raw']['color_type']) {
                        case 0:
                        case 4:
                            $info_png_chunk_type_text['background_gray']  = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']);
                            break;

                        case 2:
                        case 6:
                            $info_png_chunk_type_text['background_red']   = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 0 * $info_png['IHDR']['raw']['bit_depth'], $info_png['IHDR']['raw']['bit_depth']));
                            $info_png_chunk_type_text['background_green'] = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 1 * $info_png['IHDR']['raw']['bit_depth'], $info_png['IHDR']['raw']['bit_depth']));
                            $info_png_chunk_type_text['background_blue']  = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 2 * $info_png['IHDR']['raw']['bit_depth'], $info_png['IHDR']['raw']['bit_depth']));
                            break;

                        case 3:
                            $info_png_chunk_type_text['background_index'] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']);
                            break;
                ...
                case 'pHYs': // Physical Pixel Dimensions
                    $info_png_chunk_type_text['header']                 = $chunk;
                    $info_png_chunk_type_text['pixels_per_unit_x']      = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 0, 4));
                    $info_png_chunk_type_text['pixels_per_unit_y']      = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 4, 4));
                    $info_png_chunk_type_text['unit_specifier']         = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 8, 1));
                ...
                case 'sBIT': // Significant Bits
                    ...
                    switch ($info_png['IHDR']['raw']['color_type']) {
                        case 0:
                            $info_png_chunk_type_text['significant_bits_gray']  = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 0, 1));
                            break;

                        case 2:
                        case 3:
                            $info_png_chunk_type_text['significant_bits_red']   = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][0]);
                            $info_png_chunk_type_text['significant_bits_green'] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][1]);
                            $info_png_chunk_type_text['significant_bits_blue']  = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][2]);
                            break;                                                                                                                     
                                                                                                                                                       
                        case 4:                                                                                                                        
                            $info_png_chunk_type_text['significant_bits_gray']  = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][0]);
                            $info_png_chunk_type_text['significant_bits_alpha'] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][1]);
                            break;                                                                                                                     
                        ...
                        case 6:                                                                                                                        
                            ...
                            $info_png_chunk_type_text['significant_bits_green'] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][1]);
                            $info_png_chunk_type_text['significant_bits_blue']  = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][2]);
                            $info_png_chunk_type_text['significant_bits_alpha'] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][3]);
                            break;
                ...
                case 'sPLT': // Suggested Palette
                    ...
                    list($palettename, $otherdata) = explode("\x00", $info_png_chunk_type_text['header']['data'], 2);
                ...
                case 'hIST': // Palette Histogram
                    $info_png_chunk_type_text['header'] = $chunk;
                    $h_ist_counter = 0;
                    while ($h_ist_counter < strlen($info_png_chunk_type_text['header']['data'])) {
                        $info_png_chunk_type_text[$h_ist_counter] = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], $h_ist_counter / 2, 2));
                        $h_ist_counter += 2;
                    }
                    break;
                ...
                case 'tIME': // Image Last-Modification Time
                    $info_png_chunk_type_text['header'] = $chunk;
                    $info_png_chunk_type_text['year']   = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 0, 2));
                    $info_png_chunk_type_text['month']  = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']{2});
                    $info_png_chunk_type_text['day']    = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']{3});
                    $info_png_chunk_type_text['hour']   = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']{4});
                    $info_png_chunk_type_text['minute'] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']{5});
                    $info_png_chunk_type_text['second'] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data']{6});
                ...
                case 'oFFs': // Image Offset
                    $info_png_chunk_type_text['header']         = $chunk;
                    $info_png_chunk_type_text['position_x']     = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 0, 4), false, true);
                    $info_png_chunk_type_text['position_y']     = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 4, 4), false, true);
                    $info_png_chunk_type_text['unit_specifier'] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][8]);
                ...
                case 'pCAL': // Calibration Of Pixel Values
                    $info_png_chunk_type_text['header']             = $chunk;
                    list($calibrationname, $otherdata)              = explode("\x00", $info_png_chunk_type_text['header']['data'], 2);
                    $info_png_chunk_type_text['calibration_name']   = $calibrationname;
                    $info_png_chunk_type_text['original_zero']      = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 0, 4), false, true);
                    $info_png_chunk_type_text['original_max']       = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 4, 4), false, true);
                    $info_png_chunk_type_text['equation_type']      = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][8]);
                    $info_png_chunk_type_text['equation_type_text'] = getid3_png::PNGpCALequationTypeLookup($info_png_chunk_type_text['equation_type']);
                    $info_png_chunk_type_text['parameter_count']    = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][9]);
                    $info_png_chunk_type_text['parameters']         = explode("\x00", substr($info_png_chunk_type_text['header']['data'], 10));
                    break;


                case 'sCAL': // Physical Scale Of Image Subject
                    $info_png_chunk_type_text['header']         = $chunk;
                    $info_png_chunk_type_text['unit_specifier'] = getid3_lib::BigEndian2Int(substr($info_png_chunk_type_text['header']['data'], 0, 1));
                    $info_png_chunk_type_text['unit']           = getid3_png::PNGsCALUnitLookup($info_png_chunk_type_text['unit_specifier']);
                    list($info_png_chunk_type_text['pixel_width'], $info_png_chunk_type_text['pixel_height']) = explode("\x00", substr($info_png_chunk_type_text['header']['data'], 1));
                    break;
                ...
                case 'gIFg': // GIF Graphic Control Extension
                    ...
                    $info_png_chunk_type_text[$gIFg_counter]['disposal_method'] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][0]);
                    $info_png_chunk_type_text[$gIFg_counter]['user_input_flag'] = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][1]);
                    $info_png_chunk_type_text[$gIFg_counter]['delay_time']      = getid3_lib::BigEndian2Int($info_png_chunk_type_text['header']['data'][2]);
                    break;
                ...
                case 'gIFx': // GIF Application Extension
                    ...
                    $info_png_chunk_type_text[$gIFx_counter]['application_identifier'] = substr($info_png_chunk_type_text['header']['data'],  0, 8);
                    $info_png_chunk_type_text[$gIFx_counter]['authentication_code']    = substr($info_png_chunk_type_text['header']['data'],  8, 3);
                    $info_png_chunk_type_text[$gIFx_counter]['application_data']       = substr($info_png_chunk_type_text['header']['data'], 11);
                    break;
