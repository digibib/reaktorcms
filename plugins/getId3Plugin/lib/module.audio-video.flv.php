...
// |                                                                      |
// | Modifications by Allan Hansen <ahØartemis*dk> 8 July 2006            |
// | Adapted module for PHP5 and getID3 2.0.0.                            |
// +----------------------------------------------------------------------+
//
// $Id: module.audio-video.flv.php,v 1.2 2006/06/24 22:58:30 ah Exp $
		...
		while ((ftell($this->getid3->fp) + 1) < $info['avdataend']) {
			...
			switch ($tag_type) {
				...
				case getid3_flv::TAG_META:
					...
					$info['meta'][$eventName] = $reader->readData();
					unset($reader);
