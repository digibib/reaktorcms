...
// +----------------------------------------------------------------------+
//
// $Id: module.tag.lyrics3.php,v 1.2 2006/06/06 18:38:54 ah Exp $
...
class getid3_lyrics3 extends getid3_handler
{
    ...
    public function Analyze() {
        ...
        if ($lyrics3_end == 'LYRICSEND') {
            ...
            $lyrics3_size    = 5100;
            $lyrics3_offset  = $getid3->info['filesize'] - 128 - $lyrics3_size;
            $lyrics3_version = 1;
        } 
        ...
        elseif (substr(strrev($lyrics3_id3v1), 0, 9) == 'DNESCIRYL') {            // strrev('LYRICSEND') = 'DNESCIRYL'
            ...
            $lyrics3_size    = 5100;
            $lyrics3_offset  = $getid3->info['filesize'] - $lyrics3_size;
            $lyrics3_version = 1;
            $lyrics3_offset  = $getid3->info['filesize'] - $lyrics3_size;
        } 
