...
abstract class BasesfGuardUserPermissionPeer {
	...
	const EXCLUDE = 'sf_guard_user_permission.EXCLUDE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'PermissionId', 'Exclude', ),
		BasePeer::TYPE_COLNAME => array (sfGuardUserPermissionPeer::USER_ID, sfGuardUserPermissionPeer::PERMISSION_ID, sfGuardUserPermissionPeer::EXCLUDE, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'permission_id', 'exclude', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'PermissionId' => 1, 'Exclude' => 2, ),
		BasePeer::TYPE_COLNAME => array (sfGuardUserPermissionPeer::USER_ID => 0, sfGuardUserPermissionPeer::PERMISSION_ID => 1, sfGuardUserPermissionPeer::EXCLUDE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'permission_id' => 1, 'exclude' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserPermissionPeer::EXCLUDE);
