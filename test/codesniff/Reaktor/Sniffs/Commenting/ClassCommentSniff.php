...
if (class_exists('Reaktor_Sniffs_Commenting_FileCommentSniff', true) === false) {
    throw new PHP_CodeSniffer_Exception('Class Reaktor_Sniffs_Commenting_FileCommentSniff not found');
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Reaktor_Sniffs_Commenting_ClassCommentSniff extends Reaktor_Sniffs_Commenting_FileCommentSniff
{
