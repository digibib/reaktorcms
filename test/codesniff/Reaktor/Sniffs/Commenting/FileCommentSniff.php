...
class Reaktor_Sniffs_Commenting_FileCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processTags($commentStart, $commentEnd)
    {
        ...
        $tags = array(
                 'category'   => array(
                                  'required'       => false, //Russ Flynn edit
        ...
        $docBlock    = (get_class($this) === 'Reaktor_Sniffs_Commenting_FileCommentSniff') ? 'file' : 'class';
