<?php
/**
 * Reaktor_Sniffs_Files_LineLengthSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Reaktor_Sniffs_Files_LineLengthSniff extends Generic_Sniffs_Files_LineLengthSniff
{
     ...
     * @var int
     */
    protected $absoluteLineLimit = 500;
