...
<div id="home_content">
    ...
    <div id="top_block_center" class="big_artwork">
      <h1 id='latest'><?php echo __('Latest published') ?></h1>
  ...
  <div class="list_block_wrapper">
    ...
    <div class='list_row clearboth'>
       <?php echo image_tag('musikk_' . $bannerfarge . '.png', 'size=450x120') ?>
    </div>
    ...
    <div class='list_row clearboth'>
      ...
      <div class="my_page_block">
        ...
        <?php include_component('sfComment','commentTitleList', array('mode' => 'reaktor')); ?>       
      </div>  
