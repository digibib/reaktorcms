...
abstract class BaseSubreaktorI18nPeer {

	
	const DATABASE_NAME = 'propel';

	
	const TABLE_NAME = 'subreaktor_i18n';

	
	const CLASS_DEFAULT = 'lib.model.SubreaktorI18n';
	...
	const NAME = 'subreaktor_i18n.NAME';

	
	const ID = 'subreaktor_i18n.ID';

	
	const CULTURE = 'subreaktor_i18n.CULTURE';
