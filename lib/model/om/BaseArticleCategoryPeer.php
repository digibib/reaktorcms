...
abstract class BaseArticleCategoryPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ArticleCategory';
	...
	const ARTICLE_ID = 'article_category.ARTICLE_ID';

	
	const CATEGORY_ID = 'article_category.CATEGORY_ID';

	
	const ID = 'article_category.ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ArticleId', 'CategoryId', 'Id', ),
