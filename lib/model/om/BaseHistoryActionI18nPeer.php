...
abstract class BaseHistoryActionI18nPeer {

	
	const DATABASE_NAME = 'propel';

	
	const TABLE_NAME = 'history_action_i18n';

	
	const CLASS_DEFAULT = 'lib.model.HistoryActionI18n';
	...
	const DESCRIPTION = 'history_action_i18n.DESCRIPTION';

	
	const ID = 'history_action_i18n.ID';

	
	const CULTURE = 'history_action_i18n.CULTURE';
