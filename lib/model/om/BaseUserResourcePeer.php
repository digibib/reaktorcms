...
abstract class BaseUserResourcePeer {

	
	const DATABASE_NAME = 'propel';

	
	const TABLE_NAME = 'user_resource';

	
	const CLASS_DEFAULT = 'lib.model.UserResource';
	...
	const ID = 'user_resource.ID';

	
	const USER_ID = 'user_resource.USER_ID';

	
	const URL = 'user_resource.URL';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Url', ),
