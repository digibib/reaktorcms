...
abstract class BaseHistoryActionPeer {

	
	const DATABASE_NAME = 'propel';

	
	const TABLE_NAME = 'history_action';

	
	const CLASS_DEFAULT = 'lib.model.HistoryAction';
	...
	const ID = 'history_action.ID';

	
	const NAME = 'history_action.NAME';
