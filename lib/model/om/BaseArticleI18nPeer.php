...
abstract class BaseArticleI18nPeer {

	
	const DATABASE_NAME = 'propel';

	
	const TABLE_NAME = 'article_i18n';

	
	const CLASS_DEFAULT = 'lib.model.ArticleI18n';
	...
	const TITLE = 'article_i18n.TITLE';

	
	const ID = 'article_i18n.ID';

	
	const CULTURE = 'article_i18n.CULTURE';
